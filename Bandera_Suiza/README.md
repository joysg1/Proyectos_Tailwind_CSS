# Bandera de Suiza - Elegante

## Diseño interactivo y responsive de la bandera suiza, implementado con Tailwind CSS.

## Características ✨

    Bandera cuadrada 1:1 con cruz blanca centrada

    Diseño completamente responsive

    Animaciones sutiles y efectos hover

    Variantes de color y representaciones alternativas

    Información histórica y simbólica detallada

## Cómo usar 🚀

## Descarga el archivo HTML y ábrelo en cualquier navegador moderno. No requiere instalación adicional.
