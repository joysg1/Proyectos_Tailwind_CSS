# Bandera de Suecia - Página Informativa

## Descripción

## Página web interactiva que presenta la bandera de Suecia con su historia, simbolismo y datos curiosos. Un diseño moderno y responsive que muestra el símbolo nacional sueco de forma educativa y visualmente atractiva.

## Características ✨

    Diseño visual de la bandera sueca con CSS

    Información histórica y simbólica
...
## Cómo usar 🚀
    ...
    Abre el archivo HTML en cualquier navegador moderno

    Navega por las secciones usando el menú superior

    Explora la información sobre la bandera sueca

    Disfruta de las animaciones y efectos visuales
